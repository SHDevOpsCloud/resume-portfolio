...
- Automation: Python scripting, log parsing, metrics collectors, file monitoring tools
- Containers: Docker fundamentals, images, volumes, logs
- Monitoring: Prometheus, Grafana, Loki, alert triage, runbook creation
...
- Comfortable with regulated environments and documentation discipline
- Eager to grow into deployment ownership, infrastructure engineering, and product contribution
